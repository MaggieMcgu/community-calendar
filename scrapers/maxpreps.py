...
KNOWN_SCHOOLS = {
    ...
    'grand-county-red-devils': {
        'name': 'Grand County High School',
        'url': 'https://www.maxpreps.com/ut/moab/grand-county-red-devils/events/',
        'location': 'Grand County High School, 608 S 400 E, Moab, UT 84532',
        'timezone': MOUNTAIN,
    },
}
